...
Using Variables
    ...
    Log   My name is Paul. My favorite color is teal. My favorite NFL team is the Jaguars.
    

    # Log the same message, but this time we use the Variable we set up in the variables section.
    Log   My name is ${name}. My favorite color is ${color}. My favorite NFL team is the ${team}.
